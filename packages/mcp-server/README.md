# API Dental Pro TypeScript MCP Server
...
```
claude mcp add api_dental_mcp_api --env API_DENTAL_API_KEY="My API Key" API_DENTAL_PRO_SDK_SOURCE="My SDK Source" API_DENTAL_PRO_SDK_LANG="My SDK Lang" -- npx -y api-dental-mcp
```
