...
export const parseClientAuthHeaders = (req: IncomingMessage, required?: boolean): Partial<ClientOptions> => { const apiKey = Array.isArray(req.headers['x-token-api']) ? req.headers['x-token-api'][0] : req.headers['x-token-api']
return {apiKey}; }
