    ...
    const res = await fetch(codeModeEndpoint, {
      ...
      headers: {
        ...
        client_envs: JSON.stringify({
          API_DENTAL_API_KEY: readEnv('API_DENTAL_API_KEY'),
          API_DENTAL_PRO_SDK_SOURCE: readEnv('API_DENTAL_PRO_SDK_SOURCE'),
          API_DENTAL_PRO_SDK_LANG: readEnv('API_DENTAL_PRO_SDK_LANG'),
        }),
      },
      body: JSON.stringify({
