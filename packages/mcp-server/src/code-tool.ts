...
const remoteStainlessHandler = async ({
  ...
  const localClientEnvs = {
    API_DENTAL_API_KEY: requireValue(
      readEnv('API_DENTAL_API_KEY') ?? client.apiKey,
      'set API_DENTAL_API_KEY environment variable or provide apiKey client option',
    ),
    API_DENTAL_PRO_BASE_URL: readEnv('API_DENTAL_PRO_BASE_URL') ?? client.baseURL ?? undefined,
  };
